...
public class ServiceManager {
	...
	public static void manageServices(Announcement announcement) {
	...
	public static String removeService(ArrayList<String> services, Announcement announcement) {
	...
	public static String deleteService(Announcement announcement) {
		if (announcement.getServices().isEmpty()) {
